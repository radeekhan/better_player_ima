...
class VideoPlayerWithIMA extends StatefulWidget {
  final String contentVideoUrl;
  final String adTagUrl;

  const VideoPlayerWithIMA({
    super.key,
  ...
  @override
  State<VideoPlayerWithIMA> createState() => _VideoPlayerWithIMAState();
}

class _VideoPlayerWithIMAState extends State<VideoPlayerWithIMA> with WidgetsBindingObserver {
  ...
  late BetterPlayerController _contentVideoController;
  ...
  void _initializeVideoPlayer() {
    ...
    _contentVideoController = BetterPlayerController(betterPlayerConfiguration);
  ...
  void _onVideoStateChanged() {
    print("Video State Changed ${_contentVideoController.videoPlayerController!.value.position} ${_contentVideoController.videoPlayerController!.value.duration}");
  ...
  void _handleAdEvent(AdEvent event) {
    switch (event.type) {
      case AdEventType.loaded:
        print("Ad Event Loaded");
        _adsManager?.start();
      case AdEventType.contentPauseRequested:
        print("Ad Event Content Pause Requested");
        _pauseContent();
      case AdEventType.contentResumeRequested:
        print("Ad Event Content Resume Requested");
        _resumeContent();
      case AdEventType.allAdsCompleted:
        print("Ad Event All Ads Completed");
        _cleanupAdsManager();
      default:
        break;
    }
